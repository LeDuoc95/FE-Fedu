...
import { WrapperCard, ImageCard, DescriptionCardStyle, SignCardTextStyle, NameStyle } from 'components/styles';
...
const CardText = ({img, author, name, description_card_text, type}) => {
    ...
    return (
        <WrapperCard card_text>
            ...
            <ImageCard card_text src={img || 'https://i.imgur.com/0jk1ek2.jpg'} alt='icon-images' />
            <NameStyle>
                {name}
            </NameStyle>
        </WrapperCard>
